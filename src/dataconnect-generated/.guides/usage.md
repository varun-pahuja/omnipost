...
```ts
import { useCreateNeighborhood, useCreatePost, useSendMessage, useListMyPosts } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateNeighborhood();
...
const { data, isPending, isSuccess, isError, error } = useListMyPosts();
...
```js
import { createNeighborhood, createPost, sendMessage, listMyPosts } from '@dataconnect/generated';


// Operation CreateNeighborhood: 
